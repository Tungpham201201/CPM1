...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold yellow](01): Increase Money ~ 1K[/bold yellow]")
            console.print("[bold yellow](02): Increase Coins ~ 3.5K[/bold yellow]")
            console.print("[bold yellow](03): King Rank ~ 4K[/bold yellow]")
            console.print("[bold yellow](04): Change ID ~ 3.5K[/bold yellow]")
            console.print("[bold yellow](05): Change Name ~ 100[/bold yellow]")
            console.print("[bold yellow](06): Change Name (Rainbow) ~ 100[/bold yellow]")
            console.print("[bold yellow](07): Number Plates ~ 2K[/bold yellow]")
            console.print("[bold yellow](08): Account Delete ~ FREE[/bold yellow]")
            console.print("[bold yellow](09): Account Register ~ FREE[/bold yellow]")
            console.print("[bold yellow](10): Delete Friends ~ 500[/bold yellow]")
            console.print("[bold yellow](11): Unlock Paid Cars ~ 4K[/bold yellow]")
            console.print("[bold yellow](12): Unlock all Cars ~ 3K[/bold yellow]")
            console.print("[bold yellow](13): Unlock all Cars Siren ~ 2K[/bold yellow]")
            console.print("[bold yellow](14): Unlock w16 Engine ~ 3K[/bold yellow]")
            console.print("[bold yellow](15): Unlock All Horns ~ 3K[/bold yellow]")
            console.print("[bold yellow](16): Unlock Disable Damage ~ 2K[/bold yellow]")
            console.print("[bold yellow](17): Unlock Unlimited Fuel ~ 2K[/bold yellow]")
            console.print("[bold yellow](18): Unlock House 3 ~ 3.5K[/bold yellow]")
            console.print("[bold yellow](19): Unlock Smoke ~ 2K[/bold yellow]")
            console.print("[bold yellow](20): Change Race Wins ~ 1K[/bold yellow]")
            console.print("[bold yellow](21): Change Race Loses ~ 1K[/bold yellow]")
            console.print("[bold yellow](22): Clone Account ~ 5K[/bold yellow]")
            console.print("[bold red](0) : Exit[/bold red]", end="\n\n")
